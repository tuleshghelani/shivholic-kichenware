...
export class ProductService {
  ...
  // Separate array for Home Decor products
  private homeDecorProducts: Product[] = [
    {
      name: 'Black Shivling',
      images: [
        'assets/home-decor/black-shivling.jpg'
      ],
      description: 'Premium black Shivling crafted from high-quality zinc metal. A sacred symbol perfect for home temples and spiritual spaces with elegant finishing.',
      details: 'Material: Zinc (Metal)\nHeight: 6.7 cm\nWidth: 2.6 cm\nLength: 8.2 cm\nWeight: 290 gm\nFinish: Premium Black Coating\nFeatures: Sacred Symbol, Durable Construction, Elegant Design\nUsage: Perfect for home temples, meditation spaces, and spiritual decor\nMaintenance: Clean with dry cloth, avoid water contact\nManufactured by: Shivholic Kitchenware',
      category: 'Home Decor',
      url: 'product/home-decor'
    },
    {
      name: 'Golden Shivling',
      images: [
        'assets/home-decor/golden-shivling.jpg'
      ],
      description: 'Exquisite golden Shivling made from premium zinc metal with lustrous golden finish. A divine addition to your sacred space with superior craftsmanship.',
  ...
  getCategories(): string[] {
    // Unique category names from both arrays
  ...
  getProductById(id: string): Product | undefined {
    ...
    const allProducts = this.getAllProducts();
    return allProducts.find(p => this.convertToId(p.name) === id);
  }
  ...
  // Get home decor products specifically
  getHomeDecorProducts(): Product[] {
    return this.homeDecorProducts;
  }
