import{Q as r}from"./chunk-NTXG2M2B.js";var l=(()=>{class s{constructor(){this.products=[{name:"Regular Chilli Cutter",images:["assets/products/Chilly-cutter/Regular-chilli-cutter/regular-chilli-cutter-1.jpg","assets/products/Chilly-cutter/Regular-chilli-cutter/regular-chilli-cutter-2.jpg","assets/products/Chilly-cutter/Regular-chilli-cutter/regular-chilli-cutter-3.jpg","assets/products/Chilly-cutter/Regular-chilli-cutter/regular-chilli-cutter-4.jpg","assets/products/Chilly-cutter/Regular-chilli-cutter/regular-chilli-cutter-5.jpg","assets/products/Chilly-cutter/Regular-chilli-cutter/regular-chilli-cutter-6.jpg"],description:"High-quality plastic/PET chilli cutter designed for efficient and precise cutting of green chilies. Perfect for everyday kitchen use.",details:`Material: Premium Plastic/PET
...
Manufactured by: Shivholic Kitchenware`,category:"Glass",url:"product/glass"}]}getCategories(){return Array.from(new Set(this.products.map(e=>e.category)))}getProducts(e){return e?this.products.filter(a=>a.category===e):this.products}getProductById(e){return this.products.find(a=>this.convertToId(a.name)===e)}getRelatedProducts(e,a=3){let t=this.getProductById(e);return t?this.products.filter(i=>i.category===t.category&&this.convertToId(i.name)!==e).slice(0,a):[]}convertToId(e){return e.toLowerCase().replace(/\s+/g,"-")}static{this.\u0275fac=function(a){return new(a||s)}}static{this.\u0275prov=r({token:s,factory:s.\u0275fac,providedIn:"root"})}}return s})();export{l as a};
